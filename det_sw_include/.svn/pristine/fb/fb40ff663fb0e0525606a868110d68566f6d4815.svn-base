...
MOD_IMAGE *id_mkmod_err_msg ( char *name, int num_x, int num_y, char *x_lab, char *y_lab, int data_type, mh_com **mod_head, char *err_msg, int max_err_msg);
MOD_IMAGE3D *id_mkmod3d_err_msg ( char *name, int num_x, int num_y, int num_t, char *x_lab, char *y_lab, char *t_lab, char ** labels, int data_type, mh_com **mod_head, char *err_msg, int max_err_msg);
