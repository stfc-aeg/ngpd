...
#define XADC_DEVICE_NAME 	"xadc"

#define XSP4_NUM_XADC	2	// Alow for 1 in Zynq and 1 in Virtex-7
...
enum XADC_Init_Type
{
	XSP4_XADC_NOT_INITIALIZED,
	XSP4_XADC_INIT_READ_ONLY,
	XSP4_XADC_INIT_FULL
};
 ...
 *
 */
int xsp4_xadc_init(enum XADC_Init_Type init_type);
