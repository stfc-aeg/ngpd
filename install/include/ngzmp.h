...
#define NGZMP_CHAN_HIST_CONT_HGT	20			//!< First of 2 hist conrtol registers, this one has flags and Nbits Height and height shift 
...
#define NGZMP_SCOPE_SEL_ANA_TEST_PAT		0
#define NGZMP_SCOPE_SEL_ANA_INPUT			1
#define NGZMP_SCOPE_SEL_ANA_FILTER			2
#define NGZMP_SCOPE_SEL_ANA_DIFF_TRIG_DIFF	3
#define NGZMP_SCOPE_SEL_ANA_DIFF_TRIG_OUT	4
#define NGZMP_SCOPE_SEL_ANA_BASELINE_SUB	5
#define NGZMP_SCOPE_SEL_ANA_BSUB_INTERNAL	6
#define NGZMP_SCOPE_SEL_ANA_ABS_TRIG		7
#define NGZMP_SCOPE_SEL_ANA_MEASURE			8
#define NGZMP_SCOPE_SEL_ANA_DATA_OUTPUT		9
#define NGZMP_SCOPE_SEL_ANA_TAIL_SUB		10
...
#define NGZMP_SCOPE_SEL37_DIG_5BIT			15

#define NGZMP_SCOPE_SEL8_DIG_4BIT			14
#define NGZMP_SCOPE_SEL8_DIG_5BIT			15

#define NGZMP_SCOPE_SEL9_DIG_4X14X2BIT		13
#define NGZMP_SCOPE_SEL9_DIG_4BIT			14
#define NGZMP_SCOPE_SEL9_DIG_5BIT			15
...
#define NGZMP_HIST_GPIO_DISABLE_UPPER	(1<<1)		//!< Disable hist stream 155..8 when present.   
...
#define AD9694_JESD_TEST_MODE_CONT			14		//!< Test mode output Continupusrepeat of user test
#define AD9694_JESD_TEST_MODE_SINGLE		15		//!< Test mode output Continupusrepeat of user test
