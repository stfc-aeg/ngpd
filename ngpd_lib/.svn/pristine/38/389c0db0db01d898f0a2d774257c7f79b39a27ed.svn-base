...
#endif
#define NGPD_FILT_NUM_COEFF		51						//!< Number of coefficients to load into the fillter see also 
...
#define NGPD_RUN_FLAGS_PLAYBACK				(1<<0)
#define NGPD_RUN_FLAGS_PLAYBACK_ALT			(2<<0)
#define NGPD_RUN_FLAGS_PLAYBACK_CONTINUOUS	(1<<2)
#define NGPD_RUN_FLAGS_SCOPEMODE			(1<<4)
#define NGPD_RUN_FLAGS_SCOPE_MOD_TO_REGS	(1<<5)
#define NGPD_RUN_FLAGS_SCOPE_REGS_TO_MOD	(1<<6)
#define NGPD_RUN_FLAGS_SCOPE_OUT_TEST		(1<<15)
#define NGPD_RUN_FLAGS_SCOPE_OUT_2_STREAM	(1<<16)

#define NGPD_RUN_FLAGS_DEFAULT				(NGPD_RUN_FLAGS_SCOPE_OUT_2_STREAM)
#define NGZMP_RUN_FLAGS_DEFAULT				(0)
/* @} */
...
#define NGPD_SCOPE_NUM_SRC0				11
#define NGPD_SCOPE_NUM_SRC1				16
#define NGPD_SCOPE_NUM_SRC2				11
...
#define NGPD_SCOPE_STATUS_RUNNING			(1<<0)
#define NGPD_SCOPE_STATUS_SCOPEOUT_RUNNING	(1<<1)
#define NGPD_SCOPE_STATUS_SCOPEOUT_PAUSED	(1<<2)
#define NGPD_SCOPE_STATUS_ITFG_RUNNING		(1<<3)
#define NGPD_SCOPE_STATUS_ITFG_WAITING		(1<<4)
#define NGPD_SCOPE_STATUS_ITFG_COUNTING		(1<<5)
...
typedef enum {
	...
	NGPDScopeStream_Unsigned=1,    //!< The data is to be interpreted as 16 bit unsiged "analogue" data.
	...
	NGPDScopeStream_AuxDigital=4   //!< The data is digital data which is associated with other streams and is ofter displayed with those streams rather than in its own right.
	} NGPDScopeStream;
