...
/*! @defgroup NGZMP_DMA_STREAM_NUMBER  Number used to identify DMA streams controlled by PPC1 in the Virtex-5 FPGA.
    @ingroup NGZMP_DMA
  @{
*/
...
/*! @defgroup NGZMP_DMA_STREAM_MASK  Binary Mask used to identify multiple DMA streams controlled by PPC1 in the Virtex-5 FPGA.
    @ingroup ZGZMP_DMA
    @{
*/
